...
namespace MARSCore
{
    public class MarsCryptor
    {
        ...
        private readonly uint[] _expandedKey = new uint[40];
        ...
        //from https://ru.wikipedia.org/wiki/MARS_%28%D0%BA%D1%80%D0%B8%D0%BF%D1%82%D0%BE%D0%B3%D1%80%D0%B0%D1%84%D0%B8%D1%8F%29
        private void ExpandKey()
        {
            var tmpLength = 15;
            var tmp = new uint[tmpLength];
            Array.Copy(_key, tmp, _key.Length);
            tmp[_key.Length] = (uint)_key.Length;
